...
HttpsServer = require("@node-wot/binding-http").HttpsServer
...
async function cubeSortLoop(WoT,thing,color) {
    ...
    try {
        ...
        await thingUarm.invokeAction("goWithSpeed", behindred);
        wait(10000);
        await thingUarm.invokeAction("goWithSpeed", pickred);
        wait(5000);
        ...
        await thingUarm.invokeAction("goWithSpeed", pickblue);
        wait(10000);
        ...
        await thingUarm.invokeAction("goWithSpeed", pickgreen);
        wait(10000);
        ...
        await thingUarm.invokeAction("goWithSpeed", picknone);
        wait(10000);
